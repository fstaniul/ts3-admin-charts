...
const COLORS = [
  ...
  ['rgba(66, 244, 229, 1)', 'rgba(66, 244, 229, .3)'],
  ['rgba(244, 66, 241, 1)', 'rgba(244, 66, 241, .3)'],
  ['rgba(13, 9, 76, 1)', 'rgba(13, 9, 76, .3)'],
  ['rgba(226, 244, 66, 1)', 'rgba(226, 244, 66, .3)'],
  ['rgba(181, 59, 247, 1)', 'rgba(181, 59, 247, .3)'],
  ['rgba(216, 145, 30, 1)', 'rgba(216, 145, 30, .3)']
];
